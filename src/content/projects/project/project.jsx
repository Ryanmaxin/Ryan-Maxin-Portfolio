        ...
        <div class="projectTile">
          ...
          <div class="projectInfo">
            ...
            <div class="tagholder">
              ...
              <div class="tag"><p>CSS</p></div>
              <div class="tag"><p>Material UI</p></div>
              <div class="tag"><p>Async</p></div>
              <div class="tag"><p>Git</p></div>
            </div>
            ...
            <div class="outlier">
              <a target="_blank" href="https://ryanmaxin.github.io/Sorting-Algorithm-Visualizer/" type="a" class="btn btn-outline-primary"><h4>Live</h4></a>
              <a target="_blank" href="https://github.com/Ryanmaxin/Sorting-Algorithm-Visualizer" type="a" class="btn btn-outline-primary"><h4>More Info</h4></a>
            </div>
          </div>
        </div>
      );
        ...
        <div class="projectTile">
          ...
          <div class="projectInfo">
            ...
            <div class="tagholder">
              ...
              <div class="tag"><p>Javascript</p></div>
              <div class="tag"><p>HTML</p></div>
              <div class="tag"><p>SASS</p></div>
              <div class="tag"><p>Material UI</p></div>
              <div class="tag"><p>Chart.js</p></div>
              <div class="tag"><p>React Router</p></div>
        ...
        <div class="projectTile">
          ...
          <div class="projectInfo">
            ...
            <div class="outlier">
              ...
              <a target="_blank" href="https://github.com/Ryanmaxin/Dinosaur-Game" type="a" class="btn btn-outline-primary"><h4>More Info</h4></a>
            </div>
          </div>
